#!/usr/bin/python3
# Sets the authorization permission flag on the LED Text characteristic.
# An authorization rule ensures that only certain strings may be written to it.
