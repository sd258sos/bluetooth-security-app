#!/usr/bin/python3
# Sets the encrypt permission flag on the LED Text characteristic so that the device must have been
# paired if writing to the LED text characteristic is to be allowed.
